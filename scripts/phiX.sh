...
phiX_reference=/sc/arion/projects/InfectiousDisease/reference-db/phiX_control
working_directory=$1
output_directory=$2
repo_directory=$3

#PhiX forward and reverse libraries
forward_lib=$working_directory/Undetermined_S0_R1_001.fastq.gz
reverse_lib=$working_directory/Undetermined_S0_R2_001.fastq.gz
