...
theoretical_df=read.table(file='/sc/arion/projects/InfectiousDisease/reference-db/microbial_community_standards/zymo_mc_16s_abundance.csv',sep=',',header=T,row.names = 1)
